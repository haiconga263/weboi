...
<head>
    ...
    <link id="changeable-colors" rel="stylesheet" href="assets/css/vitality-turquoise.css">
...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#about">DỊCH VỤ</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#process">QUY TRÌNH</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#team">ĐỘI NGŨ</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#work">DỰ ÁN</a>
                    </li>
                    <li>
    ...
    <header style="background-image: url('assets/img/creative/bg-header.jpg');">
        <div class="intro-content">
            ...
            <div class="brand-name">Web ơi</div>
            <hr class="colored">
            <div class="brand-name-subtext">Giải pháp phần mền và thiết kế website</div>
            <br>
            <div class="col-md-10 col-md-offset-1 wow fadeIn">
                <span class="quote">Sự
                    <span class="text-primary">hài lòng</span> và  
                <span class="text-primary">niềm tin</span> của khách hàng là 
                <span class="text-primary">niềm vui</span> của chúng tôi.</span>
                <hr class=" colored">
                <a class="btn btn-outline-light page-scroll" href="#contact">Liên hệ ngay!</a>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row text-center">
                <div class="col-lg-12 wow fadeIn">
                    ...
                    <p>Cung cấp giải pháp phần mềm và thiết kế website chuyên nghiệp theo nhu cầu của khách hàng</p>
                    <hr class="colored">
                </div>
            </div>
            <div class="row text-center content-row">
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".2s">
                    <div class="about-content">
                        ...
                        <h3>Application</h3>
                        <p>Nhận làm phần mền theo yêu cầu, tool, ứng dụng quản lý, ứng dụng bán hàng và quản lý kho .v.v.</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".4s">
                    <div class="about-content">
                        ...
                        <p>Nhận làm website (bán hàng, quản lý, giới thiệu, .v.v). Hiệu suất cao và chuẩn SEO. Với đội ngũ cực kỳ chuyên nghiệp và tận tình</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".6s">
                    <div class="about-content">
                        ...
                        <h3>Security</h3>
                        <p>Nhận tư vấn và thiết kế hệ thống bảo mật thông tin. An toàn trong thời đại số</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".8s">
                    <div class="about-content">
                        ...
                        <h3>IOT Service</h3>
                        <p>Nhận tư vấn và thiết lập các thiết bị IOT.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-lg-12 wow fadeIn">
                    ...
                    <hr class="colored">
                    <p>Chúng tôi sẽ làm gì khi tư vấn đến khi nhận được dự án và thực hiện như thế nào ?</p>
                </div>
            </div>
    ...
    <section class="bg-gray" id="team">
        <div class="container text-center wow fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <h2>ĐỘI NGŨ</h2>
                    <p>Với đội ngũ lập trình viên đầy kinh nghiệm, nhiệt huyết, đam mê công việc</p>
                    <hr class="colored">
                </div>
            </div>
            <div class="row content-row">
    ...
    <section id="work" class="bg-gray">
        <div class="container text-center wow fadeIn">
            ...
            <hr class="colored">
            <p>Những dự án chúng tôi đã thực hiện.</p>
        </div>
    </section>
